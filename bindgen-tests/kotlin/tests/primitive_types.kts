...
assert(outputU8Max() == 255.toUByte())
assert(outputU16Max() == 65535.toUShort())
...
assert(roundtripU8(255.toUByte()) == 255.toUByte())
assert(roundtripU16(65535.toUShort()) == 65535.toUShort())
