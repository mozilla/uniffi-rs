...
/// Zero-copy `&mut [u8]`. Overwrites `buf` with a known
...
/// Zero-copy `&mut [u8]`. Increments every byte, wrapping.
#[uniffi::export]
pub fn increment_bytes(buf: &mut [u8]) {
