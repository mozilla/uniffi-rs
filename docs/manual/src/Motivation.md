...
* Optionally, describe parts of your component API using an *Interface Definition Language* in a separate file like `./src/lib.udl`, you'll generate a bunch of boilerplate rust code that exposes this API as a C-compatible FFI layer, and include it as part of your crate.
* `cargo build` your crate as normal to produce a shared library.
* Run `uniffi-bindgen generate ... -l kotlin` to generate a Kotlin library that can load your shared library
