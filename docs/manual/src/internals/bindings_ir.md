...
4. The next pass is lanugage-specfic and transforms the general IR into a language-specific IR.
...
See `./bindings_ir_passes.md` for details on how IR passes are implemented.
...
// Medata buffer for `arithmetic::add()`, generated by the `uniffi::export` macro.
...
## General IR -> Lanuage-specific IR
...
## Langauge-specific IR -> Generated Bindings Code
