...
class TestCoverall < Test::Unit::TestCase
  ...
  def test_complex_errors
    ...
    rescue CoverallUpstreamCompatibility::ComplexError::UnknownError => err
      assert_equal err.to_s, 'CoverallUpstreamCompatibility::ComplexError::UnknownError()'
    else
      raise 'should have thrown'
    end
  ...
  def test_bytes
    coveralls = CoverallUpstreamCompatibility::Coveralls.new "test_bytes"
