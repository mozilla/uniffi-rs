...
pub fn map_type_node(type_node: general::TypeNode, context: &Context) -> Result<TypeNode> {
    Ok(TypeNode {
        ...
        read_fn_rs: read_fn_rs(&type_node.ty),
        write_fn_rs: write_fn_rs(&type_node.ty),
        read_fn_kt: read_fn_kt(&type_node.ty),
        write_fn_kt: write_fn_kt(&type_node.ty),
...
pub fn read_fn_rs(ty: &Type) -> String {
    match ty {
...
pub fn write_fn_rs(ty: &Type) -> String {
    match ty {
...
pub fn read_fn_kt(ty: &Type) -> String {
    match ty {
...
pub fn write_fn_kt(ty: &Type) -> String {
    match ty {
