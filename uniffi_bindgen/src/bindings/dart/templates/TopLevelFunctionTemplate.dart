...
public func {{ func.name()|fn_name }}({%- call dart::arg_list_decl(func) -%}) async {% call dart::throws(func) %}{% match func.return_type() %}{% when Some with (return_type) %} -> {{ return_type|type_name }}{% when None %}{% endmatch %} {
    let future = {% call dart::to_ffi_call(func) %}
