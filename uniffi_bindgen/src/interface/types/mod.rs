...
pub enum Type {
    ...
    Sequence(Box<Type>),
    Map(/* String, */ Box<Type>),
    // Types generated by uniffi but defined in other crates.
    // Associated: (type_name, crate_name)
...
impl Type {
    ...
    pub fn canonical_name(&self) -> String {
        match self {
            ...
            Type::Imported(nm, ..) => format!("Imported{}", nm),
        }
    }
}
...
impl From<&Type> for FFIType {
    fn from(t: &Type) -> FFIType {
        match t {
            ...
            Type::Imported(..) => FFIType::RustBuffer,
        }
    }
}
