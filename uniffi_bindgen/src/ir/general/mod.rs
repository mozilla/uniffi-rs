...
ir! {
    ...
    pub struct AsyncData {
        ffi_rust_future_poll: FfiType,
        ffi_rust_future_cancel: FfiType,
        ffi_rust_future_free: FfiType,
        ffi_rust_future_complete: FfiType,
    }
    ...
    #[derive(Debug, Clone, PartialEq, Node)]
    pub struct RustFfiFunctionName(String);
