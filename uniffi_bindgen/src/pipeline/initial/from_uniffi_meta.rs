...
pub struct UniffiMetaConverter {
    ...
    module_docstrings: IndexMap<String, String>,
        ...
        match meta {
            ...
            uniffi_meta::Metadata::UniffiTrait(ut) => {
                ...
                self.uniffi_traits
                    .entry((meth.module_path.clone(), meth.self_name.clone()))
                    .or_default()
                    .push(UniffiTrait::try_from_node(ut)?);
            }
            uniffi_meta::Metadata::ObjectTraitImpl(imp) => {
                ...
                self.trait_impls
                    ...
                    .or_default()
                    .push(ObjectTraitImpl {
                        tr_module_name: match &imp.tr_module_path {
                            None => None,
                            Some(module_path) => Some(
                                get_module_name(&self.module_path_map, module_path)?.to_string(),
                            ),
                        },
