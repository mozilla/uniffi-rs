...
mod test {
    ...
    impl MockEventLoop {
        ...
        pub fn new_handle(self: &Arc<Self>) -> Handle {
            <Self as HandleAlloc<crate::UniFfiTag>>::new_handle(Arc::clone(self))
        }
    ...
    extern "C" fn mock_executor_callback(
        ...
        let eventloop = <MockEventLoop as HandleAlloc<crate::UniFfiTag>>::get_arc(handle);
