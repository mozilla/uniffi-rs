...
impl CustomTypeOptions {
    fn is_remote(&self) -> bool {
        // Until we land #2807, force all custom types to act as if `remote` was present.  This
        // causes the generate code to only implement FfiConverter for the local tag, which is the
