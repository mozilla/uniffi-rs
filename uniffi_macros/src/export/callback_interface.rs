...
fn trait_impl_pointer_ffi(
    ...
    Ok(quote! {
        ...
        pub struct #vtable_type {
            pub uniffi_free: extern "C" fn(uniffi_buf: *mut u8),
            pub uniffi_clone: extern "C" fn(uniffi_buf: *mut u8),
            #(#vtable_fields)*
        }
        ...
        #[allow(missing_docs)]
        #[unsafe(no_mangle)]
        pub unsafe extern "C" fn #init_ident(vtable: ::std::ptr::NonNull<#vtable_type>) {
            if #vtable_once.set(<#vtable_type as ::std::clone::Clone>::clone(vtable.as_ref())).is_err() {
