...
pub mod kw {
    ...
    syn::custom_keyword!(into_existing);
    syn::custom_keyword!(try_from_existing);
    // This isn't currently used, but will be once we land #2807 which should happen before the
